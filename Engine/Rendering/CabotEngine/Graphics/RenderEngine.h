...
public: // 外からアクセスしたいのでGetterとして公開するもの
	ID3D12Device6* Device(){return m_pDevice.Get();}
	ID3D12GraphicsCommandList* CommandList(){return m_pCommandList.Get();}
	UINT CurrentBackBufferIndex(){return m_CurrentBackBufferIndex;}
