...
void ChangeRenderPassPipelineState(RendererRef renderer, RenderPassPipelineStateKey key);

void FlushAndWait(Effekseer::Backend::GraphicsDeviceRef graphicsDevice);

Effekseer::RefPtr<CommandList> CreateCommandList(Effekseer::Backend::GraphicsDeviceRef graphicsDevice,
    Effekseer::RefPtr<SingleFrameMemoryPool> memoryPool);

Effekseer::RefPtr<SingleFrameMemoryPool> CreateSingleFrameMemoryPool(Effekseer::Backend::GraphicsDeviceRef renderer);
