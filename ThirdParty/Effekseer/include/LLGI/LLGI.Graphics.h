...
protected:
    ...
    /**
      @brief	create buffer
    */
    virtual Buffer *CreateBufferInternal(int32_t size)
    {
        return nullptr;
    }
...
public:
    ...
    virtual bool GetIsColorCleared() const
    {
        return isColorCleared_;
    }

    virtual bool GetIsDepthCleared() const
    {
        return isDepthCleared_;
    }

    virtual Color8 GetClearColor() const
    {
        return color_;
    }
    ...
    bool GetHasDepthTexture() const
    {
        return GetDepthTexture() != nullptr;
    }

    Texture *GetResolvedRenderTexture() const
    {
        return resolvedRenderTexture_;
    }

    Texture *GetResolvedDepthTexture() const
    {
        return resolvedDepthTexture_;
    }

    virtual bool GetIsSwapchainScreen() const;

    virtual Vec2I GetScreenSize() const
    {
        return screenSize_;
    }
...
public:
    ...
    /*[[deprecated("use Platform::SetWindowSize.")]]*/
    ...
    */
    ...
    virtual Texture *CreateTexture(const TextureInitializationParameter &parameter)
    {
        return nullptr;
    }

    virtual Texture *CreateRenderTexture(const RenderTextureInitializationParameter &parameter)
    {
        return nullptr;
    }

    virtual Texture *CreateDepthTexture(const DepthTextureInitializationParameter &parameter)
    {
        return nullptr;
    }
    ...
    */
    ...
    virtual bool IsResolvedDepthSupported() const
    {
        return false;
    }
};
