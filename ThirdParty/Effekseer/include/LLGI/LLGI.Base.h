...
static constexpr int RenderTargetMax = 8;
static constexpr int VertexLayoutMax = 16;
static constexpr int TextureSlotMax = 8;
...
template <typename T>
bool BitwiseContains(T value, T elm)
{
...
template <>
struct hash<LLGI::TextureFormatType>
{
